...
// end include: preamble.js
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(5, 0, 1, fd, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 0, 1, fd, owner, group);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 0, 1, fd, length);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, buf, size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, fd, dirp, count);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(12, 0, 1, fd, op, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 0, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 0, 1, path);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, target, dirfd, linkpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1, dirfd, path, times, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(26, 0, 1, addr, len, prot, flags, fd, offset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 0, 1, fd, pbuf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(32, 0, 1, fd, offset, whence, newOffset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(33, 0, 1, fd);
...
var _load_image = Module['_load_image'] = createExportWrapper('load_image', 1);
...
var _get_level_count = Module['_get_level_count'] = createExportWrapper('get_level_count', 1);
var _get_level_downsample = Module['_get_level_downsample'] = createExportWrapper('get_level_downsample', 2);
var _get_icc_profile_size = Module['_get_icc_profile_size'] = createExportWrapper('get_icc_profile_size', 1);
var _read_icc_profile = Module['_read_icc_profile'] = createExportWrapper('read_icc_profile', 2);
var _get_best_level_for_downsample = Module['_get_best_level_for_downsample'] = createExportWrapper('get_best_level_for_downsample', 2);
var _get_level_dimensions = Module['_get_level_dimensions'] = createExportWrapper('get_level_dimensions', 2);
var _free_result = Module['_free_result'] = createExportWrapper('free_result', 1);
var _read_region = Module['_read_region'] = createExportWrapper('read_region', 6);
var _get_property_names = Module['_get_property_names'] = createExportWrapper('get_property_names', 1);
var _get_property_value = Module['_get_property_value'] = createExportWrapper('get_property_value', 2);
