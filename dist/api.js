...
function unbox_small_structs(type_ptr) {
  ...
  while (type_id === 13) {
    if (GROWABLE_HEAP_U32()[(type_ptr >> 2) + 0] > 16) {
      break;
    }
...
function ffi_call_js(cif, fn, rvalue, avalue) {
  ...
  for (var i = 0; i < nfixedargs; i++) {
    ...
    switch (arg_type_id) {
     ...
     case 12:
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 0]);
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 1]);
      sig += "j";
      break;
     ...
     case 4:
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 0]);
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 1]);
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 2]);
      args.push(GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 3]);
      sig += "jj";
      break;
    ...
    for (var i = nargs - 1; i >= nfixedargs; i--) {
      ...
      switch (arg_type_id) {
       ...
       case 4:
        ...
        GROWABLE_HEAP_U32()[(cur_stack_ptr >> 2) + 0] = GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 0];
        GROWABLE_HEAP_U32()[(cur_stack_ptr >> 2) + 1] = GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 1];
        GROWABLE_HEAP_U32()[(cur_stack_ptr >> 2) + 2] = GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 2];
        GROWABLE_HEAP_U32()[(cur_stack_ptr >> 2) + 3] = GROWABLE_HEAP_U32()[(arg_ptr >> 2) + 3];
        break;
  ...
  switch (rtype_id) {
   ...
   case 12:
    GROWABLE_HEAP_U32()[(rvalue >> 2) + 0] = result;
    GROWABLE_HEAP_U32()[(rvalue >> 2) + 1] = getTempRet0();
    break;
...
function createLegalizerWrapper(trampoline, sig) {
  if (!sig.includes("j")) {
  ...
  var wrappersig = [ sig[0].replace("j", "i"), sig.slice(1).replace(/j/g, "ii") ].join("");
  var typeSectionBody = [ 3 ];
  generateFuncType(wrappersig, typeSectionBody);
  generateFuncType(sig, typeSectionBody);
  generateFuncType("i", typeSectionBody);
  var typeSection = [ 1 ];
  uleb128Encode(typeSectionBody.length, typeSection);
  typeSection.push.apply(typeSection, typeSectionBody);
  sections.push(typeSection);
  var importSection = [ 2, 13, 2, 1, 101, 1, 114, 0, 2, 1, 101, 1, 102, 0, 0 ];
  sections.push(importSection);
  var functionSection = [ 3, 2, 1, 1 ];
  sections.push(functionSection);
  var exportSection = [ 7, 5, 1, 1, 102, 0, 2 ];
  ...
  for (var i = 1; i < sig.length; i++) {
    if (sig[i] == "j") {
      ...
      localGet(i - 1);
      convert_code.push(66, 32, 136, 167);
    } else {
      localGet(i - 1);
    }
  }
  convert_code.push(16, 1);
  if (sig[0] === "j") {
    convert_code.push(173, 16, 0, 172, 66, 32, 134, 132);
  }
...
function ffi_prep_closure_loc_js(closure, cif, fun, user_data, codeloc) {
  ...
  function trampoline() {
    ...
    for (;carg_idx < nfixedargs; carg_idx++) {
      ...
      switch (arg_type_id) {
       ...
       case 12:
        ...
        GROWABLE_HEAP_U32()[(cur_ptr >> 2) + 1] = cur_arg;
        break;
       ...
       case 4:
        ...
        GROWABLE_HEAP_U32()[(cur_ptr >> 2) + 1] = cur_arg;
        cur_arg = args[jsarg_idx++];
        GROWABLE_HEAP_U32()[(cur_ptr >> 2) + 2] = cur_arg;
        cur_arg = args[jsarg_idx++];
        GROWABLE_HEAP_U32()[(cur_ptr >> 2) + 3] = cur_arg;
        break;
      }
    }
    ...
    stackAlloc(0);
    0;
    getWasmTableEntry(GROWABLE_HEAP_U32()[(closure >> 2) + 2])(GROWABLE_HEAP_U32()[(closure >> 2) + 1], ret_ptr, args_ptr, GROWABLE_HEAP_U32()[(closure >> 2) + 3]);
    stackRestore(orig_stack_ptr);
    if (!ret_by_arg) {
      switch (sig[0]) {
       case "i":
       ...
       case "j":
        setTempRet0(GROWABLE_HEAP_U32()[(ret_ptr >> 2) + 1]);
        return GROWABLE_HEAP_U32()[(ret_ptr >> 2) + 0];
  ...
  try {
    var wasm_trampoline = createLegalizerWrapper(trampoline, sig);
  } catch (e) {
    return 1;
  }
...
function ___syscall_symlinkat(target, dirfd, linkpath) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(22, 0, 1, target, dirfd, linkpath);
  try {
...
var _environ_get = function(__environ, environ_buf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 0, 1, __environ, environ_buf);
  var bufSize = 0;
...
var _environ_sizes_get = function(penviron_count, penviron_buf_size) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(28, 0, 1, penviron_count, penviron_buf_size);
...
function _fd_close(fd) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 0, 1, fd);
  try {
    var stream = SYSCALLS.getStreamFromFD(fd);
    FS.close(stream);
    return 0;
...
function _fd_fdstat_get(fd, pbuf) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(30, 0, 1, fd, pbuf);
  try {
    var rightsBase = 0;
...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(32, 0, 1, fd, offset, whence, newOffset);
  offset = bigintToI53Checked(offset);
  try {
    if (isNaN(offset)) return 61;
    var stream = SYSCALLS.getStreamFromFD(fd);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_chmod, ___syscall_faccessat, ___syscall_fchmod, ___syscall_fchown32, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_poll, ___syscall_readlinkat, ___syscall_renameat, ___syscall_rmdir, ___syscall_stat64, ___syscall_symlinkat, ___syscall_unlinkat, ___syscall_utimensat, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_sync, _fd_write ];
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ invoke_iiiijiii,
    /** @export */ invoke_iiijjjjji,
    /** @export */ invoke_iijii,
    /** @export */ invoke_jii,
    /** @export */ invoke_v,
    /** @export */ invoke_vi,
